...
<div class="text-center p-15 bg-purple-300 text-white">
    ...
    <span class="font-extrabold block text-gray-600 text-4xl py-1">
        and my engaging storytelling brings destinations to life,
    </span>
    <span class="font-extrabold block text-gray-600 text-4xl py-1">
        inspiring readers to embark on their own adventures."
    </span>
...
<div class="text-center  py-15">
    ...
    <p class="m-auto w-4/5 text-gray-500">
        "Discover the latest updates and delve into our recent post to stay informed about the newest travel experiences and destinations."
     </p>
</div>

<div class="sm:grid grid-cols-2 w-4/5 m-auto">
    <div class="flex bg-indigo-400 text-gray-100 pt-10">
        <div class="m-auto pt-4 pb-16 sm:m-auto w-4/5 block">
            <h3 class="text-xl font-bold py-10">
                "Seattle's vibrant coffee scene is a captivating blend of rich flavors, cozy cafes, and passionate baristas, making it a must-visit destination for coffee enthusiasts around the world."
             </h3>
            <a 
                href="/blog/seattle-coffee-scene"
                class="uppercase bg-transparent border-2 border-gray-100 text-gray-100 text-xs font-extrabold py-3 px-5 rounded-3xl">
                More Coffee?!
            </a>
        </div>
